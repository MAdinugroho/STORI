...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="" method="post" value='kasir_login'>
    ...
    <!-- /.social-auth-links -->
    <!--
    //this feature was deprecated due merged issue between adminLogin and userLogin
    <a href="adminLogin">Login Admin </a><br>
    -->
  </div>
  <!-- /.login-box-body -->
</div>
