...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <p><?php echo $this->session->userdata['username']; ?> is online</p>
          <br>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-home"></i> <span>Beli</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('kasirBeli'); ?>"><i class="fa fa-cogs "></i>Input Pembelian</a></li>
            <li><a href="<?php echo base_url(''); ?>"><i class="fa fa-cogs "></i>Record Beli</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-home"></i> <span>Stok</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('kasirLogin'); ?>"><i class="fa fa-cogs "></i>Cek Stok</a></li>
            <li><a href="<?php echo base_url('kasirLogin'); ?>"><i class="fa fa-cogs "></i>Input Stok</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="#">Lab Software</a>.</strong> All rights
    reserved.
  </footer>
