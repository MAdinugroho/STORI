  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="<?php echo base_url('adminRecord'); ?>">
            <i  class="fa fa-shopping-cart"></i> <span>Laporan Penjualan</span>
          </a>
        ...
        <li class="treeview">
          <a href="<?php echo base_url('adminstok'); ?>">
            <i class="fa fa-industry"></i> <span>Laporan Stok</span>
          </a>
